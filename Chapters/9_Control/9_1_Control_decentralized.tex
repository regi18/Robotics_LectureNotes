...
Applicando le regole dell'algebra dei blocchi, è possibile ricavare la funzione di trasferimento fra il disturbo $D$ e l’uscita $\theta_m$ del sistema: $\Theta_m(s) / D(s)$.
